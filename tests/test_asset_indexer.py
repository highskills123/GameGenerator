"""
Unit tests for game_generator.asset_importer.AssetIndexer.
"""
...
from game_generator.asset_importer import AssetIndexer, import_assets
...
class TestAssetIndexerScan(unittest.TestCase):
    ...
    def setUp(self):
        # Build a temporary directory with a mix of asset and non-asset files
    ...
    def test_scan_returns_only_asset_files(self):
        ...
        # All returned items must be Path objects
    ...
    def test_scan_extensions_included(self):
        ...
        # Expect only recognised extensions
        from game_generator.asset_importer import ASSET_EXTENSIONS
...
class TestAssetIndexerMatch(unittest.TestCase):
    ...
    def setUp(self):
        self.tmp = tempfile.mkdtemp()
        # Create files with names that should match specific roles
        files = [
            "player_idle.png",
            "enemy_walk.png",
            "bullet_small.png",
...
class TestImportAssets(unittest.TestCase):
    ...
    def test_import_copies_files(self):
        ...
        # All returned paths must exist relative to dest
        for rel in paths:
