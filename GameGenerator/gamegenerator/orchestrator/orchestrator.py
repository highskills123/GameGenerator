"""
gamegenerator/orchestrator/orchestrator.py – Main game generation orchestrator.
...
class Orchestrator:
    ...
    def run(
        ...
        Args:
            ...
            auto_fix:             Re-run validation after patching.
        ...
        from gamegenerator.asset_importer import import_assets
        from gamegenerator.zip_exporter import export_to_zip
        from gamegenerator.workers.validator import ValidatorWorker
